...
public class BasePageObject {
    ...
    private void waitFor(ExpectedCondition<WebElement> condition, Duration timeOutInSeconds) {
        timeOutInSeconds = timeOutInSeconds != null ? timeOutInSeconds : Duration.ofDays(30);
    ...
    public void scrollToBottom() {
        ...
        jsExecutor.executeScript("window.scrollTo(0, document.body.scrollHeigth)");
    }
    ...
    public String getCookie(String name) {
        log.info("Getting cookies value "+ name);
